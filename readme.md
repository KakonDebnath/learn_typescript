...
```ts
//  one line
const name: string = "Kakon Debnath";
...
friends = ["Kakon Debnath", "ratul hossain"];
...
isBoolean = "Kakon Debnath"; // Errors : type 'boolean' is not assignable to type boolean[].
...
-  ### Tuple in Type Alias:
   ...
   const user1: TUserData = ["Kakon Debnath", 21, false];
...
-  Example :
   ...
   const user1 : TUserName = 'Kakon Debnath";
   ...
   // output1: isAvail1 =Kakon Debnath
...
const userName: TNullAbleString = "Kakon Debnath";
...
-  Example :
   ...
   // assign array :
   random = ["Kakon Debnath", "ratul hossain", 20, 40];
